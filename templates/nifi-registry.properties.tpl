...
nifi.registry.web.http.host={{getenv "NIFI_REGISTRY_WEB_HTTP_HOST" .Env.HOSTNAME}}
nifi.registry.web.http.port={{getenv "NIFI_REGISTRY_WEB_HTTP_PORT" "18080"}}
...
nifi.registry.db.directory={{getenv "NIFI_REGISTRY_DB_DIR" ""}}
{{if .Env.NIFI_REGISTRY_DB_DIR }}
nifi.registry.db.url.append={{getenv "NIFI_REGISTRY_DB_URL_APPEND" ";LOCK_TIMEOUT=25000;WRITE_DELAY=0;AUTO_SERVER=FALSE"}}
{{else }}
nifi.registry.db.url.append=
{{end }}

# database properties
nifi.registry.db.url={{getenv "NIFI_REGISTRY_DB_URL" "jdbc:h2:./database/nifi-registry-primary;AUTOCOMMIT=OFF;DB_CLOSE_ON_EXIT=FALSE;LOCK_MODE=3;LOCK_TIMEOUT=25000;WRITE_DELAY=0;AUTO_SERVER=FALSE"}}
nifi.registry.db.driver.class={{getenv "NIFI_REGISTRY_DB_CLASS" "org.h2.Driver"}}
nifi.registry.db.driver.directory={{getenv "NIFI_REGISTRY_DB_DRIVER_DIR" ""}}
nifi.registry.db.username={{getenv "NIFI_REGISTRY_DB_USER" "nifireg"}}
nifi.registry.db.password={{getenv "NIFI_REGISTRY_DB_PASS" "nifireg"}}
nifi.registry.db.maxConnections={{getenv "NIFI_REGISTRY_DB_MAX_CONNS" "5"}}
nifi.registry.db.sql.debug={{getenv "NIFI_REGISTRY_DB_DEBUG_SQL" "false"}}
