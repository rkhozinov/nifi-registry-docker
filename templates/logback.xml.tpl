...
<configuration scan="true" scanPeriod="30 seconds">
    ...
    <logger name="org.hibernate.type" level="{{getenv "LOG_LEVEL" "INFO"}}" />
    ...
    <logger name="org.apache.nifi.registry.provider.hook.LoggingEventHookProvider" level="{{getenv "LOG_LEVEL" "INFO"}}" additivity="false">
